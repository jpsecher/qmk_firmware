...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWE_MAC] = LAYOUT_voyager(
    ...
    XXXXXXX,  KC_Z,     KC_X,     KC_C,     V_NUM,    KC_ESC,                          KC_ENT,   N_NUM,    KC_M,     KC_COMM,  KC_DOT,   XXXXXXX,
                                                      ESC_NAV,  OSM_LSFT,    OSL_SYM,  KC_SPC
  ),
  [_NAV_MAC] = LAYOUT_voyager(
    KC_MPRV,  _______,  _______,  _______,  _______,  _______,                         _______,  _______,  _______,  _______,  _______,  KC_MNXT,
  ...
  [_SYMBOLS] = LAYOUT_voyager(
    ...
    _______,  KC_BSLS,  KC_LCBR,  KC_GRAVE, KC_RCBR,  KC_UNDS,                         KC_COMM,  KC_EXLM,  KC_AT,    KC_HASH,  KC_PIPE,  _______,
  ...
  [_NUM_MAC] = LAYOUT_voyager(
    ...
    _______,  KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_UNDS,                         KC_COMM,  KC_1,     KC_2,     KC_3,     KC_DOT,   _______,
