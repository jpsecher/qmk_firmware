...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_ALP_MAC] = LAYOUT(
    ...
    KC_TAB,   A_AGR,    S_ALT,    D_GUI,    F_CTL,    KC_G,      KC_H,     J_CTL,    K_GUI,    L_ALT,    B_AGR,    KC_ENT,
              KC_Z,     KC_X,     KC_C,     V_NUM,                         N_NUM,    KC_M,     KC_COMM,  KC_DOT,
              KC_MNXT,  ESC_FUNM, MO_NAV,   OSM_LSFT,                      OSL_SYM,  KC_SPC,   KC_BSPC,  KC_MPLY
  ),
  [_NAV_MAC] = LAYOUT(
              OSL_ALPM, GUIY,     KC_WH_D,  KC_WH_U,  KC_BTN2,   CTLA,     KC_PGDN,  KC_PGUP,  CTLE,     QK_LLCK,
    _______,  GUIA,     KC_LALT,  KC_LGUI,  KC_LCTL,  KC_BTN1,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  SAVE,     _______,
  ...
  [_NUM_MAC] = LAYOUT(
    ...
    _______,  F5_AGR,   F6_ALT,   F7_GUI,   F8_CTL,   KC_MINS,   KC_0,     FOUR_CTL, FIVE_GUI, SIX_ALT,  KC_PLUS,  _______,
              ...
              QK_BOOT,  KC_UNDS,  LCK_ALPM, KC_SLSH,                       KC_COMM,  _______,  _______,  KC_PWR
  ),
  [_SYMBOLS] = LAYOUT(
              KC_SPC,   KC_LPRN,  KC_QUOT,  KC_RPRN,  KC_EQL,    KC_COLN,  KC_AMPR,  KC_ASTR,  KC_QUES,  QK_LLCK,
