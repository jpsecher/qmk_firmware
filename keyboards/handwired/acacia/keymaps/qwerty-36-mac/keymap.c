...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_ALP_MAC] = LAYOUT(
    ...
    KC_TAB,   A_AGR,    S_ALT,    D_GUI,    F_CTL,    KC_G,      KC_H,     J_CTL,    K_GUI,    L_ALT,    B_AGR,    XXXXXXX,
              ...
              KC_MNXT,  KC_ESC,   MO_NAVM,  OSM_LSFT, XXXXXXX,   XXXXXXX,  KC_BSPC,  KC_SPC,   OSL_SYM,  KC_MPLY,  DB_TOGG
  ),
  [_NAV_MAC] = LAYOUT(
    _______,  OSL_ALP,  GUIY,     KC_WH_D,  KC_WH_U,  KC_BTN1,   CTLA,     KC_PGDN,  KC_PGUP,  CTLE,     QK_LLCK,  _______,
    _______,  GUIA,     KC_LALT,  KC_LGUI,  KC_LCTL,  KC_BTN2,   KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  M_SAVE,   KC_ENT,
  ...
  [_NUM_MAC] = LAYOUT(
    ...
    _______,  F5_AGR,   F6_ALT,   F7_GUI,   F8_CTL,   KC_MINS,   KC_0,     FOUR_CTL, FIVE_GUI, SIX_ALT,  KC_PLUS,  KC_ENT,
              KC_F9,    KC_F10,   KC_F11,   KC_F12,                        KC_1,     KC_2,     KC_3,     KC_DOT,
              QK_BOOT,  KC_UNDS,  LCK_ALPM, KC_SLSH,  _______,   _______,  _______,  _______,  KC_COMM,  KC_PWR,   DB_TOGG
  ),
  [_SYMBOLS] = LAYOUT(
    _______,  KC_SPC,   KC_LPRN,  KC_QUOT,  KC_RPRN,  KC_EQL,    KC_COLN,  KC_AMPR,  KC_ASTR,  KC_QUES,  QK_LLCK,  _______,
    KC_TILD,  KC_SCLN,  KC_LBRC,  KC_DQUO,  KC_RBRC,  KC_MINS,   KC_0,     KC_DLR,   KC_PERC,  KC_CIRC,  KC_PLUS,  _______,
              ...
              KC_VOLD,  KC_UNDS,  LCK_ALPM, KC_SLSH,  _______,   _______,  _______,  _______,  KC_COMM,  KC_VOLU,  DB_TOGG
  ),
  [_ALP_OVL] = LAYOUT(
