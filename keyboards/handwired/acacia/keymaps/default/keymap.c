...
#define M_ALT LALT_T(KC_M)
#define COMM_AGR RALT_T(KC_COMM)
#define DOT_CTL RCTL_T(KC_DOT)
...
#define GRV_ALT LALT_T(KC_GRV)
#define ONE_ALT LALT_T(KC_1)
#define TWO_AGR RALT_T(KC_2)
#define THRE_CTL RCTL_T(KC_3)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAVI_FN] = LAYOUT(
    ...
    OSM_LSFT, KC_WH_U,  KC_HOME,  KC_PGUP,  KC_END,   KC_SLSH,    KC_TILD,  KC_LEFT,  KC_UP,    KC_RGHT,  KC_WH_D,  OSM_RSFT,
              KC_LGUI,  KC_LCTL,  KC_PGDN,  KC_LALT,                        KC_LALT,  KC_DOWN,  KC_RCTL,  KC_RGUI,
              KC_MPRV,  _______,  KC_BSPC,  _______,  _______,    _______,  _______,  _______,  _______,  KC_PWR,   EE_CLR
  ),
  [_SYM_NUM] = LAYOUT(
    KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,   KC_PERC,  KC_CIRC,    KC_BTN1,  KC_7,     KC_8,     KC_9,     KC_UNDS,  KC_ASTR,
    KC_QUES,  KC_LCBR,  KC_LPRN,  KC_RPRN,  KC_RCBR,  KC_PIPE,    KC_AMPR,  KC_4,     KC_5,     KC_6,     KC_MINS,  KC_PLUS,
              BSLS_GUI, LBRC_CTL, RBRC_AGR, GRV_ALT,                        ONE_ALT,  TWO_AGR,  THRE_CTL, EQL_GUI,
