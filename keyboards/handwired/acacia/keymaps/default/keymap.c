...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT(
    ...
    KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,       KC_N,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_ENT,
             ...
             KC_MNXT, OSM_ALT, BS_NAV,  ESC_CTL, OSM_AGR,    OSM_SFT, DEL_GUI, SPC_SYM, OSM_ALT, KC_MPLY, DB_TOGG
  ),
  [_NAVI_FN] = LAYOUT(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,      KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
    KC_TAB,  KC_WBAK, KC_WREF, KC_BTN2, KC_BTN1, KC_TILD,    KC_GRV,  KC_LEFT, KC_UP,   KC_RGHT, KC_PGUP, KC_ENT,
             KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE,                      KC_HOME, KC_DOWN, KC_END,  KC_PGDN,
             KC_MPRV, _______, _______, _______, _______,    _______, _______, SPC_CTL, _______, KC_PWR,  _______
  ),
  [_SYM_NUM] = LAYOUT(
    ...
    KC_QUES, KC_SLSH, KC_LBRC, KC_LCBR, KC_LPRN, KC_PIPE,    KC_0,    KC_4,    KC_5,    KC_6,    KC_MINS, KC_EQL,
             ...
             KC_VOLD, _______, BS_GUI,  _______, _______,    _______, _______, _______, _______, KC_VOLU, _______
  )
};
